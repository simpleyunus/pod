        ...
        theme={{
          ...
          components: {
            ...
            Button: {
              ...
              colorPrimaryActive: '#0B1220',
              primaryShadow: '0 1px 2px rgba(16,24,40,.2)',
              defaultBorderColor: '#E9E9E4',
            ...
            Table: {
              ...
              headerColor: '#98A0AC',
              headerSortActiveBg: '#F6F6F3',
              headerSortHoverBg: '#F6F6F3',
              rowHoverBg: '#FAFAF7',
              borderColor: '#F1F1EC',
              cellPaddingBlock: 14,
              fontSize: 13,
            ...
            Radio: { buttonSolidCheckedBg: '#101828' },
            Drawer: { borderRadiusLG: 16 },
            Modal: { borderRadiusLG: 16 },
            Message: { borderRadiusLG: 12 },
            Timeline: { tailColor: '#E9E9E4' },
